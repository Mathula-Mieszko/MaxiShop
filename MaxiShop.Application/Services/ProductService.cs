...
namespace MaxiShop.Application.Services
{
    public class ProductService : IProductService
    {
        ...
        {
            var products = await _productRepository.GetAllProdutDetailsAsync();
        ...
        {
            var data = await _productRepository.GetAllProdutDetailsAsync();
        ...
        public async Task<PaginationViewModel<ProductDto>> GetPagination(PaginationInputModel pagination)
        {
            var source = await _productRepository.GetAllProdutDetailsAsync();
